...
fcsts_to_compare = {
    ...
    'w-lgbm-naive_theta-010': 'active-weights_by_model_naive_theta-010-20220701',
    'w-lgbm-naive_ma-010_theta-010': 'active-weights_by_model_naive_ma-010_theta-010-20220701',
    'w-lgbm-naive-ma_x050-theta_x050': 'active-weights-lgbm-naive-ma_x050-theta_x050-20220701',
}
...
# ens_test_w_cv_weights           3135.000     2.734     4.845    0.000    0.284     0.761     1.537     2.959     8.696    13.494    20.335    95.927
# ens_test_w_test_weights         3135.000     1.044     2.993    0.000    0.046     0.230     0.458     0.979     3.398     5.788     7.805    94.376
# w-lgbm-model_all                3135.000     2.044     3.751    0.000    0.220     0.582     1.153     2.251     6.120     9.646    13.511    94.845
# w-lgbm-model_naive_ma_theta     3135.000     1.932     3.674    0.000    0.214     0.543     1.056     2.124     5.888     8.794    13.323    94.862
# w-lgbm-model_naive_theta        3135.000     1.923     3.568    0.000    0.221     0.551     1.052     2.121     5.832     8.968    13.329    94.876
# w-lgbm-naive_theta-010          3135.000     1.904     3.536    0.000    0.209     0.540     1.040     2.091     5.844     9.066    13.231    94.773
# w-lgbm-naive_ma-010_theta-010   3135.000     1.903     3.538    0.000    0.216     0.535     1.035     2.096     5.856     9.081    13.231    94.773
# w-lgbm-naive-ma_x050-theta_x050 3135.000     1.901     3.573    0.000    0.213     0.524     1.040     2.088     5.779     8.860    13.216    94.683
